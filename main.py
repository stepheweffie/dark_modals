        ...
        with modal and bg:
            ...
            with content:
                ...
                with ui.row().classes('w-full items-center px-4'):
                    ...
                    ui.input(label='Email', placeholder='Enter Email')
                with ui.row().classes('w-full items-center px-4'):
                    ui.button('Submit', on_click=lambda: bg_modal.remove(bg)).classes('text-xl w-72')

    # Open the modals
    ui.button('Open Modal').on('click', user_modal)
